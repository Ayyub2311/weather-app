  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "dark:bg-sidebar bg-foreground/25 relative grow overflow-hidden rounded-4xl data-horizontal:h-3 data-horizontal:w-full data-vertical:h-full data-vertical:w-3"
        )}
      >
