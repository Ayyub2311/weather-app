...
function App() {
  ...
  return (
    <>
      ...
      <div
        className="flex flex-col gap-8 pt-4 xs:pt-8 p-8 w-full 
      lg:w-[calc(100dvw-var(--sidebar-width))] 2xl:h-screen 2xl:min-h-[1120px]
      "
      >
        ...
        <div className="grid grid-cols-1 flex-1 min-h-0 md:grid-cols-2 2xl:grid-cols-4 2xl:grid-rows-4 gap-4">
